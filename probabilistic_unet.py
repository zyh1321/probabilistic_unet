...
class ProbabilisticUnet(nn.Module):
    ...
    def __init__(self, input_channels=1, num_classes=4, num_filters=[48, 96, 192, 384, 768], latent_dim=6, no_convs_fcomb=4,
                 beta=10.0):
    ...
    def forward(self, patch, segm, training=True):
        ...
        为patch构建预先的潜在空间，并通过UNet运行patch，如果是训练，还可以构建后验空间
        """
        if training:
